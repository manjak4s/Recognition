    ...
    public void run() {
        ...
        if (applyMatrix) {
            if (info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
                if (xact.host.getDeviceProfile().portraitFFCFlipped() && (xact.displayOrientation == 90 || xact.displayOrientation == 270)) {
...
//                cleaned = Bitmap.createBitmap(original, 0, 0, original.getWidth(), original.getHeight(), matrix, true);
//                original.recycle();
                ////////////////////////////////////////////////////////////////////////////////
                ...
                Camera.Parameters parameters = xact.cameraView.getCamera().getParameters();
                ...
                //preview from camera
                cleaned = BitmapFactory.decodeByteArray(data, 0, data.length, opt);
            }
        }
